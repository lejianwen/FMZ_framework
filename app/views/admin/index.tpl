...
<aside class="Hui-aside">
  ...
  <div class="menu_dropdown bk_2">
    <dl id="menu-article">
      ...
      <dd>
        <ul>
          <li><a _href="/admin/test/index" data-title="测试列表" href="javascript:void(0)">测试列表</a></li>
        </ul>
      </dd>
    </dl>
    {if $admin_group_id == 1}
...
<section class="Hui-article-box">
  <div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
    ...
    <div class="Hui-tabNav-more btn-group"><a id="js-tabNav-prev" class="btn radius btn-default size-S" href="javascript:;"><i class="Hui-iconfont">&#xe6d4;</i></a><a id="js-tabNav-next" class="btn radius btn-default size-S" href="javascript:;"><i
