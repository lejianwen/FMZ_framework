    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-7">
        <span class="btn-upload form-group">
          <input class="input-text upload-url radius" type="text" name="uploadfile-1" id="uploadfile-1" readonly disabled>
          <a href="javascript:void();" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe642;</i> 浏览文件</a>
          <input type="file" multiple name="headimg" class="input-file">
        </span>
      </div>
    </div>
    <div class="row cl">
