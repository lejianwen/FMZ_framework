...
class Config extends Model
{
     ...
     *     @SWG\Property(property="name",type="string", description="名称",example="52FMZ"),
     *     @SWG\Property(property="code",type="string", description="配置码",example="YOUR_CODE"),
     *     @SWG\Property(property="value",type="string", description="配置值",example="我的码呀"),
     *     @SWG\Property(property="status",type="number", description="状态 1启用， 2 禁用",example="1", enum={1,2}),
